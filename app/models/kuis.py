...
class Kuis(Base):
    ...
    kecepatan = sa.Column('kecepatan', sa.Integer, nullable=False)
    ketepatan = sa.Column('ketepatan', sa.Integer, nullable=False)
    tanggal = sa.Column('tanggal', sa.Date, nullable=False)
